...
<div class="content-wrapper">
    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
        ...
        <!-- /.col -->
        <div class="col-sm-6">
          <h4 class="text-center">SURAT PERNYATAAN<br>MELAKUKAN KEGIATAN <?php echo $kegiatan[0]['namaUnsur'] ?><br><br><br><br></h4>
        </div>
        <!-- /.col -->
        <div class="col-sm-3">
        </div>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          <a href="<?php echo base_url().'kegiatan/printSpmk/'.$kegiatan[0]['idKegiatanHarian']; ?>" target="_blank" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-print"></i> Print</a>
        </div>
      </div>
    </section>
    </div>