    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
              <a class="btn btn-primary" href="<?php echo base_url(); ?>rescuer/addNew">Tambahkan Data</a>
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url().'rescuer/editOld/'.$record->userId; ?>"><i
  ...
  jQuery(document).ready(function () {
    ...
    jQuery(document).on('click', '.deleteUser', function () {
      var userId = $(this).data('userid'),
        hitURL = '<?php echo base_url() ?>' + 'rescuer/deleteUser',
        currentRow = $(this);

      var confirmation = confirm("Apakah kamu yakin menghapus data ini ?");
