            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>pangkat/editPangkat" method="post" id="editPangkat" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        <label for="fname">Pangkat Lengkap</label>
                                        <input type="text" class="form-control" id="fpangkat" placeholder="Pangkat Lengkap" name="fpangkat" value="<?php echo $namaPangkat; ?>" maxlength="128">
